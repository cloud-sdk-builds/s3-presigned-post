...
[`@aws-sdk/s3-presigned-post`](https://www.npmjs.com/package/@aws-sdk/s3-presigned-post/v/3.824.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.824.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/s3-presigned-post": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.824.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.824.0/index.min.mjs": "sha384-x+34Htyaagf/jDWC2DWIouf+p57gOYIsHdPj4KVizZO10eykv9RK8q/8SEByhwEL"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.824.0`)
...
```
https://github.com/cloud-sdk-builds/s3-presigned-post/blob/refs/tags/3.824.0/LICENSE
```
