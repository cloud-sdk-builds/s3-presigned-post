...
[`@aws-sdk/s3-presigned-post`](https://www.npmjs.com/package/@aws-sdk/s3-presigned-post/v/3.309.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.309.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/s3-presigned-post": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.309.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.309.0/index.min.mjs": "sha384-vQssSqRkiKg1qOVw9Mpr+1BDsPaPBowq11rLP+BrTGBPx8/RpoUg2p2twEmdC8x+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/s3-presigned-post/blob/refs/tags/3.309.0/LICENSE
```
