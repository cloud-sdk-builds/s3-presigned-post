...
[`@aws-sdk/s3-presigned-post`](https://www.npmjs.com/package/@aws-sdk/s3-presigned-post/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.377.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/s3-presigned-post": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.377.0/index.min.mjs": "sha384-g6/+yMawcEB7noVTBXmLbn1Aufp/uDc+NDpLA0i/ipQhvcUirR8iKKXcIMHGRNGX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/s3-presigned-post/blob/refs/tags/3.377.0/LICENSE
```
