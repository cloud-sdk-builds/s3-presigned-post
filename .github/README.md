...
[`@aws-sdk/s3-presigned-post`](https://www.npmjs.com/package/@aws-sdk/s3-presigned-post/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.423.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/s3-presigned-post": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.423.0/index.min.mjs": "sha384-a7ULdQXw7VhugBtkHEMJwl0xkFaaUGnUXej2Cvayw4JaWV5X4skiKaW2W3WzqEYU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/s3-presigned-post/blob/refs/tags/3.423.0/LICENSE
```
