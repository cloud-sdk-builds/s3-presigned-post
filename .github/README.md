...
[`@aws-sdk/s3-presigned-post`](https://www.npmjs.com/package/@aws-sdk/s3-presigned-post/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.713.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/s3-presigned-post": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.713.0/index.min.mjs": "sha384-MQmPDPr5+nWVqU7dE4VNtKXieX8+2chJ4b5gdEReETWSUIAni5+wYvAGAebxH323"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/s3-presigned-post/blob/refs/tags/3.713.0/LICENSE
```
