...
[`@aws-sdk/s3-presigned-post`](https://www.npmjs.com/package/@aws-sdk/s3-presigned-post/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0o3XKGKrv2DlNYXQ98YM+pbiDkSSC50wIFXfl4RZ88ZkLhKIeG58pQbMBeeJys15
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/s3-presigned-post": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/s3-presigned-post@3.55.0/index.min.mjs": "sha384-0o3XKGKrv2DlNYXQ98YM+pbiDkSSC50wIFXfl4RZ88ZkLhKIeG58pQbMBeeJys15"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/s3-presigned-post/blob/refs/tags/3.55.0/LICENSE
```
